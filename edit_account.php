<section class="py-5">
        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    ...
                    <a href="./?p=my_account" class="btn btn-dark btn-flat">
                    ...
                    <div class="col-md-6">
                        <form action="" id="update_account">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="lastname" class="form-control form" value="<?php echo $_SESSION['lastname']?>" required>
                            </div>
                            <div class="form-group">
                                <label for="" class="control-label">Contact</label>
                                <input type="text" class="form-control form-control-sm form" name="contact" value="<?php echo $_SESSION['contact']?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control form" rows='3' name="address"><?php echo $_SESSION['address']?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="email" class="control-label">Email</label>
                                <input type="text" name="email" class="form-control form" value="<?php echo $_SESSION['email']?>" required>
                            </div>
                            <div class="form-group">
   ...
   <b> <p class="text-center mb-3">For Easy Login Option, Take a Picture</p></b>
    <?php
        ...
        $qr_code_url = "https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=" . urlencode($generated_code);
    ?>
