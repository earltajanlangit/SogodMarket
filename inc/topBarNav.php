<nav class="navbar navbar-expand-lg navbar-dark bg-navy">
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <img src="uploads/logo.png" width="130" height="60" class="d-inline-block align-top" alt="" loading="lazy">
                </a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="brandDropdown">
                            <?php 
                            $brand_qry = $conn->query("SELECT * FROM `space_type_list` where status = 1 order by `name` asc");
...
$('#search-form').submit(function(e) {
    ...
    if (sTxt != '')
        window.location.href = './?p=bikes&search=' + sTxt;
})
</script>